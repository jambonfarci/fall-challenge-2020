...
void Player::reset() {
    ...
    this->brewCount = this->sBrewCount;
    tome = sTome;
...
float Player::fitness() {
    if (this->brewCount == BREW_COUNT) {
        return INFINITY;
    }

    return this->score * 100 + this->inv1 + this->inv2 + this->inv3;
}
